...
function createTableForFlavor(table,t){
    ...
    table.appendChild(tr);
            ...
            for(i=0;i<t.length;i++){
                ...
                if(checkElementInJson(arome, t[i][0]) == true){
